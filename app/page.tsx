...
//   Configuration,OpenAI } from 'openai';
// import { Message } from "@/src/components/Message";
// // import { Loader } from "@/src/components/Loader";

// const createChatCompletion = (messages: 
...
//     scrollToLastMessage();
//     createChatCompletion(newMessages).then((response) =>{
//       const newText = response.data.data.choices[0].message?.content;
//       if(!newText){
//         return;
//       }
...
//           <button type="submit"
//       className="text-white disabled:dark:bg-blue-900
//        disabled:dark:text-gray-400 disabled:text-gray-400
//         disabled:bg-blue-500 disabled:cursor-not-allowed
//          bg-blue-800 hover:bg-blue-900 focus:ring-4
//           focus:ring-blue-400 font-medium rounded-lg 
//           text-sm px-5 py-2.5  dark:bg-blue-700
//            dark:hover:bg-blue-800 focus:outline-none
